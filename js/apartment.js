  ...
  $('#apt').innerHTML = `
    <div class="wrap sec">
      <div class="empty">
        ...
        <a class="btn btn-accent" href="catalog.html">Відкрити каталог</a>
      </div>
    </div>`;
} else {
...
function render(){
  ...
  <div class="wrap apt-main">
    ...
    <aside class="bookbox" id="bookbox">
      ...
      ${calcHTML()}
      <button class="btn btn-accent btn-block" type="button" id="toBook" style="margin-top:16px"${n ? '' : ' disabled'}>Забронювати</button>
  ...
  <div class="bookbar">
    ...
    <button class="btn btn-accent" type="button" id="barBook">${n ? 'Забронювати' : 'Обрати дати'}</button>
  </div>`;
